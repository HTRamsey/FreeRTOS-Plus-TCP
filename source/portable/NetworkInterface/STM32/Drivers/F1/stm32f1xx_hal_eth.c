...
/* STM32F1 CMSIS omits the name for the enhanced-descriptor bit. */
        #ifndef ETH_DMABMR_EDE
 ...
 */
        HAL_StatusTypeDef HAL_ETH_Init( ETH_HandleTypeDef * heth )
        {
            ...
            /* Dummy read to sync AFIO with ETH. */
            ( void ) AFIO->MAPR;
 ...
 */
                                                ...
                                                ETH_DMAConfigTypeDef * dmaconf )
        {
            ...
            /* STM32F1xx supports fixed bursts, but not mixed bursts. */
 ...
 */
                                      ...
                                      const ETH_MACConfigTypeDef * macconf )
        {
            ...
            tmpreg1 = ( heth->Instance )->MACCR;
            /* Clear WD, PCE, PS, TE and RE bits. STM32F1xx has no CSTF bit. */
